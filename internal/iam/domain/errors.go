...
var (
	...
	ErrNodeLocAccountUnavailable      = errors.New("nodeloc account is unavailable")
	ErrNodeLocIdentityAlreadyBound    = errors.New("nodeloc identity is already bound")
	ErrNodeLocPendingExpired          = errors.New("nodeloc account setup expired")
	ErrNodeLocTrustLevelTooLow        = errors.New("nodeloc trust level is too low")
