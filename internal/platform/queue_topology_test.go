...
func TestBackgroundTierOnlyServesBackgroundQueues(t *testing.T) {
	...
	if bg[QueueBackgroundValidation] != 3 || bg[QueueBackgroundGmailValidation] != 1 || bg[QueueBackgroundICloudValidation] != 1 || bg[QueueBackgroundDomainValidation] != 1 || bg[QueueBackgroundAlias] != 1 || bg[QueueBackgroundTokenRefresh] != 1 || bg[QueueBackgroundProjectHistory] != 1 || bg[QueueBackgroundGmailIdentification] != 1 || bg[QueueBackgroundProtoImport] != 1 || bg[QueueBackgroundProtoValidation] != 1 || bg[QueueBackgroundProtoHistory] != 1 || bg[QueueBackgroundInventory] != 1 || bg[QueueResource] != 2 {
...
func TestEveryQueueWeightUsesItsRuntimeSetting(t *testing.T) {
	...
	settings := []queueSetting{
		...
		{"asynq_queue_background_gmail_identification_weight", QueueBackgroundGmailIdentification, backgroundQueueConfig},
		{"asynq_queue_background_proto_import_weight", QueueBackgroundProtoImport, backgroundQueueConfig},
		{"asynq_queue_background_proto_validation_weight", QueueBackgroundProtoValidation, backgroundQueueConfig},
		{"asynq_queue_background_proto_history_weight", QueueBackgroundProtoHistory, backgroundQueueConfig},
