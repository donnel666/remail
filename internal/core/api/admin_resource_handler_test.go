...
func TestAdminMicrosoftCoreRouteSecurityMatrix(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "domain list", method: http.MethodGet, path: "/v1/admin/domains", resource: "core:resource", action: "read"},
		{name: "domain create", method: http.MethodPost, path: "/v1/admin/domains", resource: "core:resource", action: "write", csrfNeeded: true},
		{name: "domain validation batch", method: http.MethodPost, path: "/v1/admin/domains/validations", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain disable batch", method: http.MethodPost, path: "/v1/admin/domains/disable", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain publish batch", method: http.MethodPost, path: "/v1/admin/domains/publish", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain unpublish batch", method: http.MethodPost, path: "/v1/admin/domains/unpublish", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain delete batch", method: http.MethodPost, path: "/v1/admin/domains/delete", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain detail", method: http.MethodGet, path: "/v1/admin/domains/42", resource: "core:resource", action: "read"},
		{name: "domain edit", method: http.MethodPatch, path: "/v1/admin/domains/42?version=1", resource: "core:resource", action: "write", csrfNeeded: true},
		{name: "domain mailboxes", method: http.MethodGet, path: "/v1/admin/domains/42/mailboxes", resource: "core:resource", action: "read"},
		{name: "domain validate", method: http.MethodPost, path: "/v1/admin/domains/42/validate", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain dns status", method: http.MethodPost, path: "/v1/admin/domains/42/dns-status", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain enable", method: http.MethodPost, path: "/v1/admin/domains/42/enable?version=1", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain disable", method: http.MethodPost, path: "/v1/admin/domains/42/disable", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain publish", method: http.MethodPost, path: "/v1/admin/domains/42/publish?version=1", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain unpublish", method: http.MethodPost, path: "/v1/admin/domains/42/unpublish?version=1", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain delete", method: http.MethodDelete, path: "/v1/admin/domains/42?version=1", resource: "core:resource", action: "operate", csrfNeeded: true},
		{name: "domain recover", method: http.MethodPost, path: "/v1/admin/domains/42/recover?version=1", resource: "core:resource", action: "operate", csrfNeeded: true},
