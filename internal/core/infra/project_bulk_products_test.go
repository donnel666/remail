...
func TestProjectRepoBulkUpsertProductsPreservesIDsAndCreatesMissingTypes(t *testing.T) {
	...
	products := []domain.Product{
		...
		{Type: domain.ProductTypeDomain, Status: domain.ProductStatusDisabled, CodeEnabled: true, CodePrice: "0.010000", PurchasePrice: "0", CodeSupplierPrice: "0.005000", PurchaseSupplierPrice: "0", CodeWindowMinutes: 10, ActivationWindowMinutes: 60, WarrantyMinutes: 60},
	}
