...
export interface paths {
    ...
    "/v1/oauth/nodeloc": {
        ...
        get: operations["getNodeLocAuthorize"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/oauth/nodeloc": {
        ...
        get: operations["getNodeLocCallback"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/oauth/nodeloc/pending": {
        ...
        get: operations["getNodeLocPending"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/oauth/nodeloc/email/code": {
        ...
        post: operations["postNodeLocEmailCode"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/oauth/nodeloc/complete": {
        ...
        post: operations["postNodeLocComplete"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/resources/{resourceId}/messages/fetch": {
         ...
         * @description Requires `mailmatch:message/operate`, Session authentication, CSRF, and an idempotency key. `type=microsoft` uses the Microsoft resource transport; `type=gmail` uses the local Gmail IMAP transport; `type=icloud` scans Apple-forwarded SMTP mail in the authorized auxiliary-domain inbox. Every provider sends messages through the same MailMatch ingestion and order-filtering flow. MailMatch updates the resource's current fetch generation before returning 202. Disabled resources may be diagnosed without being enabled; deleted resources return 409.
         */
...
export interface components {
    schemas: {
        ...
        /** @description Legacy wire name. New campaigns use fixed prize counts; consolation is derived from the participant count, and normal/lucky are requested counts. */
        LotteryTierWeights: {
            consolation: number;
            normal: number;
            lucky: number;
        ...
        LoginConfigResponse: {
            ...
            nodelocOAuthEnabled: boolean;
            nodelocBound: boolean;
        };
        /** @enum {string} */
...
export interface operations {
    ...
    getNodeLocAuthorize: {
        ...
        requestBody?: never;
        responses: {
            /** @description Redirect to NodeLoc authorization */
            302: {
                headers: {
                    Location?: string;
                    [name: string]: unknown;
            ...
            /** @description Redirect back to login when NodeLoc OAuth is unavailable */
            303: {
                headers: {
                    Location?: string;
                    [name: string]: unknown;
    ...
    getNodeLocPending: {
        ...
        requestBody?: never;
        responses: {
            /** @description Pending NodeLoc profile and suggested account choice */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["NodeLocPendingResponse"];
                };
            };
            /** @description Pending setup expired or is unavailable */
            401: {
    ...
    postNodeLocComplete: {
        ...
        responses: {
            /** @description NodeLoc account ownership completed and session created */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Email or NodeLoc identity is already owned */
            409: {
                headers: {
                    [name: string]: unknown;
                };
        ...
        requestBody: {
            content: {
                "multipart/form-data": {
                    /**
                     * Format: binary
                     * @description UTF-8 TXT with one Gmail account per non-empty line in one of the five documented formats, using either `----` or `;` as the field delimiter. The final field is always an App Password and its whitespace is ignored; a third field containing an email address is parsed as the optional binding email.
                     */
                    file: string;
                    ownerId: number;
                    /** @enum {string} */
