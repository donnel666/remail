export const EMAIL_RESOURCE_KEYS = [
  ...
  "icloud_phone_send_failure_threshold",
  "icloud_phone_blacklist_hours",
  "domain_custom_tlds",
  "domain_sale_tld_whitelist",
  "domain_sale_quality_min_orders",
  "domain_sale_quality_min_success_percent",
  "domain_sale_quality_window_hours",
  "domain_sale_quality_check_interval_seconds",
