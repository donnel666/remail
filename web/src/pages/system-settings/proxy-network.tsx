...
const D = { proxy_check_interval_seconds: 15, proxy_failure_threshold: 3, proxy_check_timeout_seconds: 6, resource_binding_ttl_days: 7, max_proxy_attempts: 3, pending_proxy_check_limit: 100, proxy_idle_conn_timeout_seconds: 15, proxy_tls_handshake_timeout_seconds: 5 };
