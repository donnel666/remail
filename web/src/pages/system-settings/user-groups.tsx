...
const EMPTY: UserGroupFormValues = { code: "", name: "", description: "", enabled: true, apiConcurrencyLimit: 3, priceDiscountRatio: 1, topupThreshold: 0, autoUpgradeEnabled: false };
