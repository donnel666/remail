export const BACKGROUND_JOB_KEYS = [
  ...
  "asynq_queue_background_gmail_identification_weight",
  "asynq_queue_background_proto_import_weight",
  "asynq_queue_background_proto_validation_weight",
  "asynq_queue_background_proto_history_weight",
