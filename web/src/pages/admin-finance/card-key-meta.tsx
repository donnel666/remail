...
// Card-key-scoped identity helpers. Intentionally a private copy (not shared
// with invites) so the card key owner cell can diverge independently later.
...
// card key owner column, the card key detail owner field and the redemption
// records User column.
export function CardKeyAccountCell({
  userId,
  email,
  nickname,
  role,
