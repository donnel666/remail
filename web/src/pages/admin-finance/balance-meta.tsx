...
// Balance-scoped identity helpers. Intentionally a private copy (not shared with
// invites / card keys / transactions) so the balances user cell can diverge.
...
// user balances User column.
export function BalanceAccountCell({
  userId,
  email,
  nickname,
  role,
